            ...
            <div class="card card-dark">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md 10">
                            <form name="modulos_add" id="categoria_add" method="POST" enctype="multipart/form-data">
            ...
            <div class="card card-dark">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-1"></div>
                        <div class="col-md 10">
                            <form name="categoria_update" id="categoria_update" method="POST">
                                ...
                                <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="Nuevo_Nombre_Categoria">Categoria</label>
                                            <input type="text" class="form-control" id="Nuevo_Nombre_Categoria"
                                                name="Nuevo_Nombre_Categoria" required>
                                        </div>
                                    </div>
                                </div>
                        </div>
