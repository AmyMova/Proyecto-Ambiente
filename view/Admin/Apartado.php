...
<div class="container-fluid">
    <div class="row justify-content-center">
        ...
        <div id="formulario_ver_Apartado">
        <div class="card card-dark">
            <div class="card-header">
                <h3 class="card-title">Información de Apartado</h3>
            </div>
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col">
                            <form name="modulos_ver_apartado" id="apartado_ver" method="POST">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-dark">
                <div class="card-header">
                    <h3 class="card-title">Apartados existentes</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body ">
                    <div class="row ">
